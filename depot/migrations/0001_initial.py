# Generated by Django 2.1.3 on 2019-04-20 01:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample_type', models.CharField(blank=True, choices=[('', ''), ('Botanical', 'Botanical'), ('Ceramic', 'Ceramic'), ('Organic', 'Organic')], default='', max_length=200, null=True)),
        ...
        migrations.AddField(
            ...
            name='samples',
            field=models.ManyToManyField(through='depot.container_samples', to='depot.Sample'),
        ),
    ]
