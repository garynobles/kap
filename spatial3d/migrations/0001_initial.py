...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Photobatch',
            fields=[
                ('pb_id', models.AutoField(primary_key=True, serialize=False)),
                ...
                ('processed_on', models.CharField(blank=True, choices=[('', ''), ('Struthas', 'Struthas'), ('Pissuthnes', 'Pissuthnes'), ('Harpagus', 'Harpagus'), ('Tissaphernes', 'Tissaphernes'), ('Cyrus', 'Cyrus')], default='', max_length=200, null=True)),
